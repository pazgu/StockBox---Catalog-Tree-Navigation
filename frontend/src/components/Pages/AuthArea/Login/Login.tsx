  ...
  const handleLogin = async () => {
    ...
    if (!isReturningUser) {
      if (!firstName.trim()) {
        ...
        !hebrewOnly.test(firstName.trim()) &&
        !englishOnly.test(firstName.trim()) &&
        !arabicOnly.test(firstName.trim())
      ) {
        newErrors.firstName = true;
      ...
      if (!lastName.trim()) {
        ...
        !hebrewOnly.test(lastName.trim()) &&
        !englishOnly.test(lastName.trim()) &&
        !arabicOnly.test(lastName.trim())
      ) {
        newErrors.lastName = true;
    ...
    if (!isReturningUser) {
      if (!userName.trim()) {
        ...
        (userName.trim().match(/[א-תa-zA-Z\u0600-\u06FF]/g) || []).length < 2
      ) {
        newErrors.userName = true;

          ...
          <div className={MODAL_OVERLAY}>
            <div className={MODAL_CARD}>
              ...
              <p className="text-slate-700 mb-2">
                האם את/ה רוצה להכניס את המשתמש למערכת ולאפשר לו גישה לאתר?
              </p>
        ...
        {blockUserIndex !== null && (
          <div className={MODAL_OVERLAY}>
            <div className={MODAL_CARD}>
              ...
              <p className="text-slate-700 mb-2">
                {currentUsers[blockUserIndex].isBlocked
                  ? "האם את/ה בטוח/ה שברצונך לבטל את חסימת המשתמש ולאפשר לו גישה מחדש לאתר?"
                  : "האם את/ה בטוח/ה שברצונך לחסום משתמש זה מגישה למערכת?"}
              </p>
              <small className="text-gray-500 block mb-6">

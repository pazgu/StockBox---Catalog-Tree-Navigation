...
const GroupList: React.FC<GroupListProps> = ({
  ...
  flex flex-col min-h-0">
      <button
        ...
        className="mb-4 flex items-center gap-2 px-4 py-2 bg-slate-700 text-white rounded-lg hover:bg-slate-600 transition-all duration-200 shadow-md text-sm"
      >
      ...
      {filteredGroups.length === 0 ? (
        ...
        <div className="space-y-3 overflow-y-auto overflow-x-hidden pr-2 pt-4 max-h-[50vh] lg:max-h-full">
